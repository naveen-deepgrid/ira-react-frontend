          ...
          <div className="container-fluid">
              <div className="row" style={{marginTop:'2rem'}}>
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      ...
                      <h1 style={{marginTop:'-0.7rem',fontWeight:'bold',fontSize:'28px'}}>ADD A LINK</h1>
                  </div>
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              ...
              <div>
                  ...
                  <p style={{marginTop:'1rem',marginBottom:'0.5rem'}}>URL*</p>
                  <textarea rows="4" placeholder="Enter URL" className="form-control" style={{height:'44px'}}>
